...
declare namespace PoopJs {
	namespace QuerySelector {
		...
		namespace DocumentQ {
			...
			function qq<K extends keyof HTMLElementTagNameMap>(this: Document, selector: K | `${K}${'.' | '#'}${string}`): (HTMLElementTagNameMap[K])[];
		}
		namespace ElementQ {
...
declare namespace PoopJs {
	namespace FetchExtension {
		...
		function xmlDoc(url: string): Promise<Document>;
...
declare namespace PoopJs {
	namespace PaginateExtension {
		...
		class Paginate {
			...
			emitEnd(): void;
			fetchDocument(link: Link, spinner?: boolean, maxAge?: number): Promise<Document>;
...
declare namespace fetch {
	...
	const isCached: typeof PoopJs.FetchExtension.isCached;
}
interface Window {
